...
// 
//where and when to use synchronization --uesd when shared resources are there 
//where and when to use joint method
//what is shared resources -> calling one functions by multiple threads 
